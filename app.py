...
if race == "人間族":
    race_skill_text = """
【種族スキル】家柄1〜から運命装備が使用可能/投擲威力+20%/1回の戦闘で一度だけ、あらゆる基準値を１つだけ半減可能(例：基準値20→10)"""
elif race == "獣人族": 
...
♢計画部隊
└デトネーターと同じパーティーにいる状態で戦闘開始すると、HP and MPの上限が+20％される（上限値に応じて残量も合わせられる）"""
elif race == "人工獣人":
    race_skill_text = """【種族スキル】
白兵ダメージ+20%
♢造獣の怒り
